...
export function Header(){
    ...
    return(
        <header className="bg-white w-full relative z-10 text-2xl rounded-2xl flex flex-col md:flex-row md:gap-y-5 xl:gap-y-7 md:gap:10 justify-between p-10 mb-2 md:shadow-(--shadow-default)">
