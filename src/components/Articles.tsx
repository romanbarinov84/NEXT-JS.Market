        ...
        <section>
            <div className="flex flex-col justify-center xl:max-w-[1208px]">
                <div className="mb-4 md:mb-8 xl:mb-10 flex flex-row justify-between">
                    <h2 className="text-2xl xl:text-4xl text-left font-bold  text-[#606060] text-shadow-lg/10">Пости</h2>
                    <button className="flex flex-row items-center gap-x-2 cursor-pointer">
                        <Link href="#" className="text-base text-center text-shadow-lg/10 text-[#606060] hover:text-[#d2cfcf]">До постів</Link>
                        <Image src="/shevron-right.svg" alt="shevronRight-image" 
                    ...
                    <li key={article._id} className="h-75 md:h-105">
                        <article className="bg-white h-full flex flex-col rounded overflow-hidden shadow-lg hover:shadow-xl duration-500">
                            ...
                            <div className="p-2.5 flex-1 flex flex-col gap-y-2.5 leading-1.5">
                                ...
                                <h3 className="text-[#434343] text-base font-bold xl:text-lg">{article.title}</h3>
                                <p className="text-[#808080] line-clamp-3 text-xs xl:text-base">{article.text}</p>
                                <button className="rounded mt-auto w-37.5 h-10 bg-[#e5ffde] text-base text-[#6ce9a0] shadow-lg hover:shadow-xl hover:text-white duration-500 cursor-pointer">Подробиці</button>
                            </div>
                        </article>
                    </li>
                ))}
