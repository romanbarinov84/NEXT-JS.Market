...
const PasswordInput = ({id,label,value,onChangeAction,showPassword,togglePasswordVisibilityAction,
    showRequirements,compareWidth
}:PasswordInputProps) => {
    ...
    const isPasswordValid = () => {
     ...
     const shouldShowToolTip = () => {
        ...
        if(compareWidth){
         return  (value.length > 0 && compareWidth.length > 0 && value !==compareWidth)
        }
  ...
  return (
    <div className="relative">
     ...
     <div className="relative">
        ...
        />
        <button type="button" onClick={togglePasswordVisibilityAction} 
